...
public class ObjectPoolManager : MonoBehaviour{
	...
	public static int New(Transform objT, int count=1){ if(instance==null) Init(); return instance._New(objT.gameObject, count); }
	public static int New(GameObject obj, int count=1){ if(instance==null) Init(); return instance._New(obj, count); }
